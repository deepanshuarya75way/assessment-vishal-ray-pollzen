                         ...
                         <div className="mx-auto grid min-h-[92vh] max-w-7xl items-center gap-16 px-6 py-20 lg:grid-cols-2">
                              ...
                              >
                                   ...
                                   <div className="mt-14 space-y-6">
                                        ...
                                        <div className="max-w-2xl rounded-3xl border border-white/10 bg-white/[0.03] p-6 backdrop-blur-xl">
                                   ...
                                   {features.map((feature, index) => {
                                        ...
                                        return (
                                             ...
                                             <motion.div
                                                  ...
                                                  className="group rounded-3xl border border-white/10 bg-white/[0.03] p-8 transition-all duration-300 hover:-translate-y-2 hover:border-indigo-500/30 hover:bg-indigo-500/[0.03]"
                                             >
